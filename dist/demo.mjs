...
$_documentContainer$2.innerHTML = `<iron-iconset-svg name="icons" size="24">
<svg><defs>
...
$_documentContainer$7.innerHTML = `<dom-module id="paper-dialog-shared-styles">
  <template>
    <style>
      :host {
        display: block;
...
$_documentContainer$8.innerHTML = `<dom-module id="paper-material-styles">
  <template>
    <style>
      :host, html {
        --paper-material: {
...
$_documentContainer$9.innerHTML = `<dom-module id="paper-button">
...
$_documentContainer$a.setAttribute('style', 'display: none;');

$_documentContainer$a.innerHTML = `<dom-module id="paper-item-shared-styles">
  <template>
    <style>
      :host, .paper-item {
        display: block;
